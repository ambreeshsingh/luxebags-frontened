...
//     // e.target.name → which field changed (name, email etc.)
//     // e.target.value → what user typed
//     // ...form → keep all other fields as they are
//   };

//   const handlePayment = () => {
//     // Razorpay will go here later
//     // For now just show alert
//     alert(`Order placed! Total: ₹${totalPrice.toLocaleString()}`);
//     navigate("/");
//   };
...
//             </div>
//             // shows each item and its subtotal
//           ))}
...
//             className="mt-4 w-full bg-black text-white py-3 rounded-xl hover:bg-gray-800 transition text-lg"
//           >
//             Pay ₹{totalPrice.toLocaleString()} 💳
//           </button>
//           // Razorpay will replace this button later
